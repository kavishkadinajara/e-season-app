...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(getContext(), "An error occurred during initialization: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    private void checkAndInitializeUser() {
        try {
            ...
            Log.e(TAG, "Exception in checkAndInitializeUser", e);
            Toast.makeText(getContext(), "An error occurred while checking user: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadUserProfile() {
        try {
            ...
            Log.e(TAG, "Exception in loadUserProfile", e);
            Toast.makeText(getContext(), "An error occurred while loading user profile: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updateProfile() {
        try {
            ...
            Toast.makeText(getContext(), "An error occurred while updating profile: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void changePassword() {
        try {
            ...
            Log.e(TAG, "Exception in changePassword", e);
            Toast.makeText(getContext(), "An error occurred while changing password: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void logout() {
        try {
            ...
            Log.e(TAG, "Exception in logout", e);
            Toast.makeText(getContext(), "An error occurred while logging out: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void removeProfile() {
        try {
            ...
            Log.e(TAG, "Exception in removeProfile", e);
            Toast.makeText(getContext(), "An error occurred while removing profile: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}